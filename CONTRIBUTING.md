# Contributing to `attackmap-analyzer-go`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-go.git
cd attackmap-analyzer-go
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-go/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-go/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-go`, you agree that your contributions will be
